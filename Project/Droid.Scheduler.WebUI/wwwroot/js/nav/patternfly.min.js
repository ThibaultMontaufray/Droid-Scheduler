! function (window) {
    ...
    function (window) {
        "use strict";
        window.patternfly.pfPaletteColors = {
            black: "#030303",
            black100: "#fafafa",
            black200: "#ededed",
            black300: "#d1d1d1",
    ...
    function ($) {
        ...
        $.fn.initCollapseHeights = function (scrollSelector) {
            ...
            }, setCollapseHeights(), $(window).on("resize", setCollapseHeights)
        }, $.fn.initFixedAccordion = function () {
            var initOpen, fixedAccordion = this;
            ...
            }), (initOpen = $(fixedAccordion.find(".collapse.in"))[0]) && $(initOpen.parentNode).addClass("panel-open")
        }
    }(jQuery),
    function ($) {
        "use strict";
        ...
        function getParent(rows, node) {
            ...
            if ("string" == typeof parent) return isNaN(parent) ? (parent = $(parent), parent.length > 1 && (parent = rows.closest(parent))) : parent = $(rows[parseInt(parent, 10)]), parent
        }
    ...
    function ($) {
        ...
        $.fn.setupVerticalNavigation = function (handleItemSelections, ignoreDrawer, userOptions) {
            var options = $.extend({
                ...
                explicitCollapse = !1,
                subDesktop = !1,
                storageLocation = "sessionStorage" === options.storage ? "sessionStorage" : "localStorage",
                ...
                bindMenuItemsBehavior = function (handleSelection) {
                    $(document).find(".nav-pf-vertical .list-group-item").each(function (index, item) {
                        ...
                        $secondaryItem.on("click.pf.secondarynav.data-api", '[data-toggle="collapse-secondary-nav"]', function (e) {
                            var $this = $(this);
                            inMobileState() ? (updateMobileMenu(), e.stopImmediatePropagation()) : $this.hasClass("collapsed") ? (options.rememberOpenState && (window[storageLocation].setItem("patternfly-navigation-secondary", "expanded"), window[storageLocation].setItem("patternfly-navigation-tertiary", "expanded")), updateSecondaryCollapsedState(!1, $this), forceHideSecondaryMenu()) : (options.rememberOpenState && window[storageLocation].setItem("patternfly-navigation-secondary", "collapsed"), updateSecondaryCollapsedState(!0, $this)), navElement.removeClass("hover-secondary-nav-pf"), handleSelection && e.stopImmediatePropagation()
                            ...
                            $(primaryItem).on("click.pf.tertiarynav.data-api", '[data-toggle="collapse-tertiary-nav"]', function (e) {
                                var $this = $(this);
                                inMobileState() ? (updateMobileMenu($secondaryItem), e.stopImmediatePropagation()) : $this.hasClass("collapsed") ? (options.rememberOpenState && (window[storageLocation].setItem("patternfly-navigation-secondary", "expanded"), window[storageLocation].setItem("patternfly-navigation-tertiary", "expanded")), updateTertiaryCollapsedState(!1, $this), forceHideSecondaryMenu()) : (options.rememberOpenState && window[storageLocation].setItem("patternfly-navigation-tertiary", "collapsed"), updateTertiaryCollapsedState(!0, $this)), navElement.removeClass("hover-secondary-nav-pf"), navElement.removeClass("hover-tertiary-nav-pf"), handleSelection && e.stopImmediatePropagation()
                            })
                        })
            ...
            return $.fn.setupVerticalNavigation.self || ($.fn.setupVerticalNavigation.self = self, $(window).on("resize", function () {
                ...
                navElement.addClass("hide-nav-pf"), bodyContentElement.addClass("hide-nav-pf"), checkNavState(), bindMenuBehavior(), bindMenuItemsBehavior(handleItemSelections), setTooltips(), options.rememberOpenState && loadFromLocalStorage(), navElement.removeClass("hide-nav-pf"), bodyContentElement.removeClass("hide-nav-pf"), forceResize(250)
