...
namespace Droid_scheduler
{
    public class HolidayCalculator : ICloneable
    {
        ...
        public static HolidayCalculator GetCalendar(string calendarCountry)
        {
            ...
            {
                case "france":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_france);
                case "india":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_india);
                case "ireland":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_irland);
                case "canada":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_canada);
                case "germany":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_germany);
                case "japan":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_japan);
                case "russia":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_russia);
                case "togo":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_togo);
                case "great britain":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_united_kingdom);
                case "usa":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_united_state);
                case "mali":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_mali);
                case "kenya":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_kenya);
                case "guine":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_guine);
                case "republique centrafrique":
                    return new HolidayCalculator(new DateTime(DateTime.Now.Year, 1, 1), new DateTime(DateTime.Now.Year, 12, 31), Properties.Resources.holidays_republique_centrafrique);
                default:
